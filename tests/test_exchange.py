...
def prepare_transaction_arguments(world, buyer_money, seller_money, buy_price, sell_price):
    ...
    return buyer, buy_ent, buy_order, seller, sell_ent, sell_order
...
def test_process_transaction(buyer_money, seller_money, buy_price, sell_price):
    ...
    buyer, buy_ent, buy_order, seller, sell_ent, sell_order = prepare_transaction_arguments(world, buyer_money,
                                                                                            seller_money, buy_price,
                                                                                            sell_price)
    transaction_buy_price, transaction_sell_price = exchange.process_transaction(buy_ent=buy_ent, buy_order=buy_order, sell_ent=sell_ent, sell_order=sell_order)
