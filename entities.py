...
def create_person(world, name, food_consumption, food_amount, water_consumption, water_amount, money):
    ...
    needs = Needs()
    needs.add(Need("have water for tomorrow", priority=0, pile=ResourcePile(Resource.WATER, water_consumption), price_change_on_buy=1, price_change_on_failed_buy=5))
    ...
    needs.add(Need("have water for next few days", priority=2, pile=ResourcePile(Resource.WATER, 5*water_consumption), price_change_on_buy=0.9, price_change_on_failed_buy=1.5))
    ...
    needs.add(Need("have a big stash of water", priority=3, pile=ResourcePile(Resource.WATER, 15*water_consumption), price_change_on_buy=0.8, price_change_on_failed_buy=1.2))
